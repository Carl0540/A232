...
message = "Hello Guys, Welcome to My Vlog!"
...
contains_Vlog = "Vlog" in greeting
print("Does the message contain 'Vlog'? ", contains_Vlog)

# Replace part of the string
new_message = message.replace("Vlog", "World")
